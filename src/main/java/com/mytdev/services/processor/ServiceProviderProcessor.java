...
import com.mytdev.services.ServiceProviders;
...
@SupportedAnnotationTypes({
    "com.mytdev.services.ServiceProvider",
    "com.mytdev.services.ServiceProviders"
})
public class ServiceProviderProcessor extends AbstractServiceProviderProcessor {
    ...
    private void register(Element clazz, Class<? extends Annotation> annotation, ServiceProvider svc) {
        try {
            ...
            register(clazz, annotation, e.getTypeMirror(), svc.position());
        }
    }
    ...
    public Iterable<? extends Completion> getCompletions(Element annotated, AnnotationMirror annotation, ExecutableElement attr, String userText) {
        ...
        if (annotation == null
                || !"com.mytdev.services.ServiceProvider".contentEquals(((TypeElement) annotation.getAnnotationType().asElement()).getQualifiedName())) {
            return Collections.emptyList();
        }
