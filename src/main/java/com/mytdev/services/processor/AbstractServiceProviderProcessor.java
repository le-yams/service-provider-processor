 ...
 */
package com.mytdev.services.processor;
 ...
 *
 */
abstract class AbstractServiceProviderProcessor extends AbstractProcessor {
    ...
    /**
     * Register a service. If the class does not have an appropriate signature,
     * an error will be printed and the registration skipped.
     *
     * @param clazz the service implementation type (an error will be reported
     * if not a {@link TypeElement})
     * @param annotation the (top-level) annotation registering the service, for
     * diagnostic purposes
    ...
    protected final void register(
        ...
        registerImpl(clazz, impl, rsrc, position);
    }
    ...
    private void registerImpl(
            TypeElement clazz, String impl, String rsrc, int position) {
        /*
     ...
     * @return the instance of that annotation on the element, or null if not
     * found
     */
